...
Denne mappe er **den officielle BA-projektmappe**.

## Mappestruktur:
- data_raw/                → Rå CSV-filer
- data_processed/          → RDS-filer klar til modeller
- models/                  → Trænede Prophet og Hybrid modeller
- model_functions/         → Alle funktioner til FE, modelling, LP, Erlang
- pipeline/                → Scripts der kører workflowet
- shiny_app/               → Shiny-dashboard
- output/diagnostics/      → Diagnoseplots
